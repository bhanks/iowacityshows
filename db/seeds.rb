...
Venue.delete_all
#Venue.create!(:name=>"Gabe's", :address=>"330 East Washington Street", :site_url=>"http://www.iowacitygabes.com/", :display_name=>"Gabe's", :event_list_url=>"http://www.iowacitygabes.com/", :parse_type=>"WordPress")
